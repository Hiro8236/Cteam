			...
			<form action="/Cteam1/user/UserRegistSuccess.action" method="post">
				<div id="wrap_box">
					...
					<div>
						...
						<div class="form-floating mx-5 mt-3">
						    <input class="form-control px-5 fs-5" autocomplete="off"
						        id="password-input" maxlength="255" name="Password"
						        placeholder="パスワードを入力してください" type="password" required />
						...
						<div class="form-floating mx-5">
						    <input class="form-control px-5 fs-5" autocomplete="off"
						        id="confirm-password-input" maxlength="255" name="ConfirmPassword"
						        placeholder="もう一度パスワードを入力してください" type="password" required />
						    <label for="confirm-password-input">パスワード確認</label>
						</div>
					...
					<div class="mt-4">
						<input class="w-25 btn btn-lg btn-primary" type="submit" value="登録" />
					</div>
				</div>
			</form>
		</section>
